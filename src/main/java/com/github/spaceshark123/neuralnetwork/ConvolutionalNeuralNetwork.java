...
//     protected ArrayList[] filters; // filters[layer].get(filter #)[x][y][channel]
...
//     public ConvolutionalNeuralNetwork(int inputWidth, int inputHeight, int[] numChannels, int[] topology, String[] active,
//             String[] layerTypes, int[] filterSizes) {
